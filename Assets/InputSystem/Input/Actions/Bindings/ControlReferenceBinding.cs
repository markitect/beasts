...
namespace UnityEngine.Experimental.Input
{
	...
	public class ControlReferenceBinding<C, T> : InputBinding<C, T>, IEndBinding, IControlReference
		where C : InputControl<T>
	{
		...
		{
			var clone = (ControlReferenceBinding<C, T>)Activator.CreateInstance(GetType());
